...
export default function Index(props) {
  ...
  const companies = [
    { name: 'Freelance', color: '#FF0000' },
    { name: 'Upwork', color: '#A100FF' },
    { name: 'HFC Bank Kenya', color: '#0CAA41' },
  ]
  ...
  return (
    <Wrapper>
      <Head>
        ...
        <meta content="https://sabare.tech" property="og:url" />
