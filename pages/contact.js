...
export async function getStaticProps() {
  const meta = {
    title: 'Contact // Victor Sabare',
    description:
      'I love chatting with software engineers, tech founders, students, and geeks. I promise that I\'ll try to reply to your email in a timely manner.',
  ...
  return (
    <>
      <Head>
        ...
        <meta content="https://sabare.tech/contact" property="og:url" />
